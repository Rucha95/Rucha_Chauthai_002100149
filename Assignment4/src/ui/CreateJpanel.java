...
//    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IdentificationNo", "Name", "Age", "City", "Community", "HeartRate", "Diastolic Blood Pressure", "Systolic Blood pressure", "HouseNo", "HealthStatus"
            }
        ));
        ...
        searchdropdown.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select field to search", "HealthStatus", "City", "Age", "Community", "Name", "Identification Number" }));
    ...
    // Person check1 = AllpersonList.getAllpersonList().stream().filter(personList -> patientName.getText().trim()==personList.getPatientName()).findFirst().orElse(null);
         if (!patientName.getText().isEmpty() && !Community.getText().isEmpty() 
               && !BP.getText().isEmpty()
             ){
...
//        city.setText(" ");
    }else{JOptionPane.showMessageDialog(this,"Please fill in all the required fields.","Info",JOptionPane.INFORMATION_MESSAGE);}
...
private void filterRow(){
   // System.out.println("inside");
    ...
    switch(option){
                        ...
                        case "Name": index=1;
                        break;
                        case "Identification Number": index=0;
                        break;
